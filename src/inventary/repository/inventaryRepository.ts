...
export class InventaryRepository {
    public static async createInventary(cantidad: number, gorra_id: number, talla_id: number, created_by: string): Promise<Inventary | any> {
        try {
    ...
    public static async updateInventary(id: string, cantidad: number, updated_by: string): Promise<Inventary | string | any> {
        try {
    ...
    public static async getAllInventariesActive(): Promise<Inventary[]> {
        try {
    ...
    public static async deleteInventaryPermanent(id: string): Promise<Inventary | string> {
        try {
    ...
    public static async getAllInventariCaps(): Promise<Inventary[]> {
        try {
            const sql = `
                SELECT 
                    i.*, 
